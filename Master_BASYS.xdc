...
##Pmod Header JC
##Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {comp1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {comp1}]
##Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {pwm1}]					
...
##Sch name = JC7
set_property PACKAGE_PIN L17 [get_ports {comp2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {comp2}]
##Sch name = JC8
set_property PACKAGE_PIN M19 [get_ports {pwm2}]					
